;;; makefile-script.el --- Building script for emacs

;; Copyright (c) 2016 - 2017 .
;;
;; Author: xxx <xxx@xxx.com>
;; Keywords: converience
;; X-URL: http://github.com/xxx
;; Version: 0.2
...
(defun find-org-files (dirname)
  ...
  (thread-last (find-lisp-find-files dirname "^[^\\.#].*\\.org$")
    (mapcar (lambda (f) (replace-regexp-in-string
                         (expand-file-name user-emacs-directory) "" f)))))
