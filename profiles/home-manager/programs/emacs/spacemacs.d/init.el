...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     prettier
     (python :packages (not lsp-python-ms)
             :variables
             python-backend 'lsp
     ...
     (rust :packages (not cargo flycheck-rust racer ron-mode rust-mode))
     (scheme :variables
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-mode-line-theme (if (or (string-equal "frame" (daemonp))
                                        (display-graphic-p))
                                    '(spacemacs :separator arrow :separator-scale 1.0)
                                  '(spacemacs :separator utf-8 :separator-scale 1.0))
   ...
   ;; https://github.com/syl20bnr/spacemacs/issues/6195#issuecomment-332612280
   dotspacemacs-default-font (let ((fonts '("Sarasa Mono SC" "Source Code Pro")))
                               (mapcar (lambda (font)
                                         `(,font
                                           :size 16.0
                                           :weight normal
